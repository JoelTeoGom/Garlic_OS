@;==============================================================================
@;
@;	"garlic_itcm_sys.s":	cÃ³digo de las rutinas de soporte al sistema 2.0
@;						(ver "garlic_system.h" para descripciÃ³n de rutinas)
@;
@;==============================================================================
...
.section .dtcm,"wa",%progbits
	...
	.global _gs_colZoc		@; colores de las zonas de memoria de cada zÃ³calo
_gs_colZoc: .byte 0, 224, 184, 128, 48, 208, 80, 112, 96, 160, 245, 144, 176, 64, 192, 32

	.global _gs_charTabla	@; cÃ³digos de los caracteres para dibujar la tabla de procesos
_gs_charTabla:
...
_gs_iniGrafB:
 ...
 @; decompress(garlic_fontTiles, bgGetGfxPtr(bg0B), LZ77Vram);
	...
	mov r1, #0x06200000			@; R1 = base de la memoria de vÃ­deo
...
.LdibTab_for2:
	...
	mov r1, #3
	mov r2, r4
	bl _gs_num2str_dec  				@; _ga_num2str_dec(_gs_numZoc, 3, i);
	@;ldr r0, =_gs_numZoc
	mov r0, sp
	add r1, r4, #4
	mov r2, #1
