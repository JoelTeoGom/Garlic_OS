/*------------------------------------------------------------------------------
	...
	"PRTF.c" : programa de test de la funci�n de API GARLIC_printf();
				(versi�n 1.0)
...
char * const frases[] = {"Por fin lleg�. Salimos en seguida para Carmona.\n",
					...
					"Me preguntaba Mrs. Adams y yo le traduc�a: ",
					"<<La carretera, que esta podrida.>> ",
					"Ella miraba por un lado y hacia los comentarios m�s raros. ",
					"�Como puede pudrirse una carretera?\n",
					"Es Carmona una ciudad toda murallas y t�neles, la m�s fuerte de Andaluc�a en los tiempos de Jul",
					...
					"<<A la paz de Dios>>, dijo cuando lleg�.\n"};
